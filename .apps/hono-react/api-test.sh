...
# ═══════════════════════════════════════════════════════════════
# Test Product
test_crud 'Product' 'product' 'id' '{"productName":"Pinkie"}' '{"productName":"Pinkie"}' 'false'

# Test Customer
test_crud 'Customer' 'customer' 'id' '{"name":"Uriah"}' '{"name":"Uriah"}' 'false'
...
# Test User
test_crud 'User' 'user' 'id' '{"email":"gabrielle.krajcik@example.net","username":"casimir27","passwordHash":null,"firstName":null,"lastName":null,"avatarUrl":null,"emailVerified":true}' '{"email":"gabrielle.krajcik@example.net","username":"casimir27","passwordHash":null,"firstName":null,"lastName":null,"avatarUrl":null,"emailVerified":true}' 'false'

# Test Session
test_crud 'Session' 'session' 'id' '{"userId":"$TEST_USER_ID","expiresAt":"2025-10-14T06:35:31.885Z"}' '{"userId":"$TEST_USER_ID","expiresAt":"2025-10-14T06:35:31.885Z"}' 'true'

# Test Oauth Account
test_crud_composite 'Oauth Account' 'oauth-account' 'providerId,providerUserId' '{"providerId":"ulterius","providerUserId":"suscipit","userId":"$TEST_USER_ID"}' '{"providerId":"ulterius","providerUserId":"suscipit","userId":"$TEST_USER_ID"}' 'true'

# Test Profile
test_crud 'Profile' 'profile' 'id' '{"userId":"$TEST_USER_ID","bio":"cohors"}' '{"userId":"$TEST_USER_ID","bio":"cohors"}' 'true'

# Test Posts
test_crud 'Posts' 'posts' 'id' '{"userId":"$TEST_USER_ID","title":"cogo","content":null}' '{"userId":"$TEST_USER_ID","title":"cogo","content":null}' 'true'

# Test User Type
test_crud 'User Type' 'user-type' 'id' '{"name":"Judah"}' '{"name":"Judah"}' 'false'
