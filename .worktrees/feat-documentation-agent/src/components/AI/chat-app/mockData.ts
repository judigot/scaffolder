				...
				chats: [
					{
						...
						branch: "feat/dashboard-grid",
						messages: [
							{
								id: "msg-1",
								role: "user",
								content:
									"Create a responsive dashboard layout with a 12-column grid. It should support widgets of different sizes (1x1, 2x1, 2x2, etc.) and reflow on mobile.",
					...
					},
					{
						...
						prStatus: "draft",
						branch: "feat/analytics-widget",
						messages: [
							{
								id: "msg-5",
								role: "user",
								content:
									"Build an analytics widget that shows real-time visitor count with a sparkline chart",
						...
						messages: [
							{
								...
								role: "user",
								content:
									"Create an activity feed widget showing recent user actions with infinite scroll",
						...
						messages: [
							{
								...
								role: "user",
								content:
									"Set up Firebase Cloud Messaging for web push notifications. Need service worker, permission flow, and token management.",
						...
						messages: [
							{
								...
								role: "user",
								content:
									"Implement OAuth2 social login with Google, GitHub, and Twitter providers",
						...
						messages: [
							{
								...
								role: "user",
								content:
									"Add two-factor authentication using TOTP (Google Authenticator compatible)",
				...
				messages: [
					{
						...
						role: "user",
						content:
							"There's a memory leak in production. Memory usage keeps growing over time. Users are reporting the tab becomes unresponsive after a few hours.",
				...
				messages: [
					{
						...
						role: "user",
						content:
							"I want to experiment with a new dark mode color palette. The current one feels too flat. Can you suggest something with more depth?",
				...
				messages: [
					{
						...
						role: "user",
						content:
							"What's the best caching strategy for our API? We have a mix of frequently changing data (user feed) and rarely changing data (user profile, settings).",
				...
				messages: [
					{
						...
						role: "user",
						content:
							"We have duplicate form validation logic in multiple components. Can you extract it into reusable validators?",
