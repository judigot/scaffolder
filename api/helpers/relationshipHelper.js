export const addRelationship = (
  ...
  function createBasicTable(tableName) {
  ...
  function createPrimaryKeyColumn(tableName) {
    return {
  ...
  function createForeignKeyColumn(referencedTable, isOneToOne = false) {
    const returnValue = {
  ...
  function createPivotTable(sourceTableName, targetTableName) {
  ...
  function setupOneToOneOrManyRelationship(source, target) {
  ...
  function setupManyToManyRelationship(source, target, pivotTableName) {
    // Initialize arrays if they don't exist
...
export const purgeForeignKeyTraces = (schemaInfo) => {
