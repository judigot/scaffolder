 ...
 */
export const extractSeparatorValue = (propertyString) => {
 ...
 */
export const processDynamicProperties = (content, replacements) => {
  return content.replace(/\{\{([^}]+)\}\}/g, (_, placeholder) => {
 ...
 */
export const joinWithSeparator = (array, separator) => {
