...
*/
const populateFieldInfo = (records) => {
  const fields = {};
...
*/
export function identifyPivotTables(schemaInfo) {
...
*/
const determinePrimaryKeyField = (tableName, firstKey) => {
...
*/
const detectOneToManyRelationship = (rows, foreignKey) => {
...
*/
export const isJunctionTable = (relationship, schemaInfo) => {
...
*/
export const addAssociations = (schemaInfo, data = null) => {
  ...
  const handleBelongsToMany = (relationship) => {
...
*/
export function linkChildTables(schemaInfo) {
  return schemaInfo.map((relationship) => {
...
*/
export function addParentRelationships(schemaInfo) {
...
*/
export const determineUniqueForeignKeys = (schemaInfo) => {
...
*/
export function addSchemaInfo(schemaInfo, data = null) {
  const isIntrospection = data === null;
  if (!isIntrospection) {
...
*/
export function identifySchema(data) {
  const schemaInfo = Object.keys(data).map((tableName) => {
...
*/
function cleanUpSchemaInfo(schemaInfo) {
