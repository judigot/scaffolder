...
const generateTypescriptInterfaces = ({ schemaInfo, includeTypeGuards }) => {
  const generateInterface = (table, columnsInfo) => {
  ...
  const generateInterfaceContent = (table, columnsInfo) => {
  ...
  const generateTypeGuard = (table, columnsInfo) => {
    const interfaceName = table;
