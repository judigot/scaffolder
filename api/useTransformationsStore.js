...
export const useTransformationsStore = create()(
  persist((rawSet, get) => {
    const set = createTabSync('schemaInfo-sync')(rawSet);
    return {
      ...
      setIntrospectedSchema: (schemaInfo) => {
        ...
        try {
          ...
          const finalParsedSchema = fixedParsedSchema;
      ...
      setTransformations: (tempSchemaInfo) => {
