...
export const useTransformationsStore = create<IStore>((set, get) => ({
  ...
  getSchemaInfo: () => {
    ...
    // /* prettier-ignore */ const schemaInfo = [{"table":"product","tableCases":{"plural":"products","titleCase":"Product","sentenceCase":"Product","phraseCase":"product","pascalCase":"Product","camelCase":"product","kebabCase":"product","snakeCase":"product","titleCasePlural":"Products","sentenceCasePlural":"Products","phraseCasePlural":"products","pascalCasePlural":"Products","camelCasePlural":"products","kebabCasePlural":"products","snakeCasePlural":"products"},"requiredColumns":["product_id","product_name"],"columnsInfo":[{"column_name":"product_id","data_type":"number","is_nullable":"NO","column_default":"AUTO_INCREMENT","primary_key":true,"unique":false,"foreign_key":null},{"column_name":"product_name","data_type":"string","is_nullable":"NO","column_default":null,"primary_key":false,"unique":false,"foreign_key":null}],"foreignTables":[],"foreignKeys":[],"isPivot":false,"childTables":["order_product"],"hasOne":[],"hasMany":["order_product"],"belongsTo":[],"belongsToMany":["order"],"pivotRelationships":[{"relatedTable":"order","pivotTable":"order_product"}]},{"table":"customer","tableCases":{"plural":"customers","titleCase":"Customer","sentenceCase":"Customer","phraseCase":"customer","pascalCase":"Customer","camelCase":"customer","kebabCase":"customer","snakeCase":"customer","titleCasePlural":"Customers","sentenceCasePlural":"Customers","phraseCasePlural":"customers","pascalCasePlural":"Customers","camelCasePlural":"customers","kebabCasePlural":"customers","snakeCasePlural":"customers"},"requiredColumns":["customer_id","name"],"columnsInfo":[{"column_name":"customer_id","data_type":"number","is_nullable":"NO","column_default":"AUTO_INCREMENT","primary_key":true,"unique":false,"foreign_key":null},{"column_name":"name","data_type":"string","is_nullable":"NO","column_default":null,"primary_key":false,"unique":false,"foreign_key":null}],"foreignTables":[],"foreignKeys":[],"isPivot":false,"childTables":["order"],"hasOne":[],"hasMany":["order"],"belongsTo":[],"belongsToMany":[],"pivotRelationships":[]},{"table":"order","tableCases":{"plural":"orders","titleCase":"Order","sentenceCase":"Order","phraseCase":"order","pascalCase":"Order","camelCase":"order","kebabCase":"order","snakeCase":"order","titleCasePlural":"Orders","sentenceCasePlural":"Orders","phraseCasePlural":"orders","pascalCasePlural":"Orders","camelCasePlural":"orders","kebabCasePlural":"orders","snakeCasePlural":"orders"},"requiredColumns":["order_id","customer_id"],"columnsInfo":[{"column_name":"order_id","data_type":"number","is_nullable":"NO","column_default":"AUTO_INCREMENT","primary_key":true,"unique":false,"foreign_key":null},{"column_name":"customer_id","data_type":"number","is_nullable":"NO","column_default":null,"primary_key":false,"unique":false,"foreign_key":{"foreign_table_name":"customer","foreign_column_name":"customer_id"}}],"foreignTables":["customer"],"foreignKeys":["customer_id"],"isPivot":false,"childTables":["order_product"],"hasOne":[],"hasMany":["order_product"],"belongsTo":["customer"],"belongsToMany":["product"],"pivotRelationships":[{"relatedTable":"product","pivotTable":"order_product"}]},{"table":"order_product","tableCases":{"plural":"order_products","titleCase":"Order Product","sentenceCase":"Order product","phraseCase":"order product","pascalCase":"OrderProduct","camelCase":"orderProduct","kebabCase":"order-product","snakeCase":"order_product","titleCasePlural":"Order Products","sentenceCasePlural":"Order products","phraseCasePlural":"order products","pascalCasePlural":"OrderProducts","camelCasePlural":"orderProducts","kebabCasePlural":"order-products","snakeCasePlural":"order_products"},"requiredColumns":["order_product_id","order_id","product_id"],"columnsInfo":[{"column_name":"order_product_id","data_type":"number","is_nullable":"NO","column_default":"AUTO_INCREMENT","primary_key":true,"unique":false,"foreign_key":null},{"column_name":"order_id","data_type":"number","is_nullable":"NO","column_default":null,"primary_key":false,"unique":false,"foreign_key":{"foreign_table_name":"order","foreign_column_name":"order_id"}},{"column_name":"product_id","data_type":"number","is_nullable":"NO","column_default":null,"primary_key":false,"unique":false,"foreign_key":{"foreign_table_name":"product","foreign_column_name":"product_id"}}],"foreignTables":["order","product"],"foreignKeys":["order_id","product_id"],"isPivot":true,"childTables":[],"hasOne":[],"hasMany":[],"belongsTo":["order","product"],"belongsToMany":[],"pivotRelationships":[]}];
