		...
		return (
			<div className="mt-2 flex gap-2 justify-center">
				...
				<button
					...
					className="flex items-center justify-center w-8 h-8 bg-gray-600 hover:bg-red-500 text-white rounded transition-colors duration-200"
					...
					<div className="bg-gray-800/50 rounded-lg p-8 max-w-md mx-auto border border-gray-700">
						...
						<div className="space-y-3 text-sm text-fg">
							<div className="flex items-center justify-start text-left">
								<div className="w-6 h-6 bg-gray-600/20 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
					...
					<div className="pr-6 w-full md:w-80 flex-shrink-0 max-h-screen overflow-y-auto">
						...
						<div className="bg-gray-800/50 rounded-lg border border-gray-700 p-4">
							<div className="flex items-center mb-4">
								...
								<span className="ml-auto bg-gray-600/20 text-gray-300 text-xs px-2 py-1 rounded-full">
									{mainTables.length}
								</span>
							</div>
											...
											<button
												...
												className={`w-full text-left p-3 rounded-md transition-all duration-200 group ${
													isSelected
														...
														: "hover:bg-gray-700/50 text-fg hover:text-white border border-transparent"
												}`}
												onClick={() => {
										...
										.map((tableInfo) => {
											...
											return (
												...
												>
													<div className="flex items-center">
														<svg
															className={`w-4 h-4 mr-2 ${isSelected ? "text-cyan-400" : "text-gray-500 group-hover:text-gray-400"}`}
															fill="none"
															stroke="currentColor"
															viewBox="0 0 24 24"
														>
														...
														{isSelected && (
															<svg
																className="w-3 h-3 ml-auto text-cyan-400"
																fill="currentColor"
																viewBox="0 0 20 20"
															>
																<title>Selected</title>
						...
						{selectedTableIndex !== null &&
							Boolean(schemaInfo[selectedTableIndex]) && (
								<div key={schemaInfo[selectedTableIndex].tableName}>
									<div className="flex items-center justify-between mb-4">
										<h2 className="text-xl font-semibold">
											...
											{schemaInfo[selectedTableIndex].isPivot !== true &&
												schemaInfo[selectedTableIndex].viewQuery ===
													undefined && (
													<>
														&nbsp;
														<EditIcon
									...
									{/* View Query Display */}
									{schemaInfo[selectedTableIndex].viewQuery !== undefined && (
										<div className="bg-gray-800/50 rounded-lg border border-gray-700 p-4">
											...
											<div className="bg-gray-900/50 rounded-lg p-4 border border-gray-600">
												<pre className="text-sm text-fg font-mono whitespace-pre-wrap break-words overflow-x-auto">
													{schemaInfo[selectedTableIndex].viewQuery}
												</pre>
											</div>
											{schemaInfo[selectedTableIndex].viewStructure &&
												schemaInfo[selectedTableIndex].viewStructure.length >
													0 && (
													<div className="mt-4">
														...
														<div className="flex flex-wrap gap-2">
															{schemaInfo[selectedTableIndex].viewStructure.map(
																(tableName) => (
																	<span
																		key={tableName}
											...
											<>
												<div className="flex flex-wrap gap-2 mt-4">
													<button
														...
														className="px-3 py-1 bg-gray-600 text-white font-bold rounded hover:bg-gray-500"
													>
														Add One-to-One
													</button>
													<button
										...
										<>
											...
											<div className="space-y-4">
												...
												{(Boolean(
													...
													<div className="bg-gray-600/10 p-4 rounded-lg">
												...
												{schemaInfo[selectedTableIndex].belongsToMany &&
													schemaInfo[selectedTableIndex].belongsToMany.length >
														0 &&
														...
														<div className="bg-purple-500/10 p-4 rounded-lg">
															...
															<ul className="space-y-2">
																...
																{schemaInfo[
																	...
																	<li
																		key={`${rel.relatedTable}-${rel.pivotTable}`}
																		...
																		<tr key={column.column_name}>
																			...
																			<td className="border border-gray-600 px-2 py-1 relative">
																				...
																				editingCell?.field === "column_name" ? (
																					...
																					<button
																						type="button"
																						className="hover:bg-gray-600 rounded px-1 py-0.5 w-full text-left"
																						onDoubleClick={(e) => {
																							handleCellEdit(
																								filteredIndex,
																								"column_name",
												...
												<div className="space-y-4">
													...
													<div className="flex items-center gap-3">
														<button
															...
															className="px-4 py-2 bg-gray-600 hover:bg-red-500 text-white text-sm font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800"
														>
															New Row
														</button>
