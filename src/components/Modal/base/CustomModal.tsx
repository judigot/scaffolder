...
function CustomModal({
  ...
  }, [modalRoot, useStaticPortal, onClose, isOpen, handleTabKey, initialFocusRef]);
    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 id="modal-title" className="text-2xl font-semibold text-gray-800 dark:text-gray-200">
            {title}
          </h2>
          <button
