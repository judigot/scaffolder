        ...
        <div className="form-navigation flex justify-between mt-6">
          ...
          {currentStep < structure.steps.length - 1 ? (
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-600 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
