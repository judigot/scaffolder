...
describe('generateSQLInserts', () => {
  ...
  it('should generate correct SQL INSERT statements for usersPostOneToOneSchema', () => {
    ...
    expect(sqlInserts).toContain(
      `INSERT INTO "user" (user_id, first_name, last_name, email, username, password, created_at, updated_at) VALUES (1, 'John', 'Doe', 'john.doe@example.com', 'johndoe', '$2b$10$M/WlJFeICXSTwvlM54X75u9Tg5Y3w/ak5T7O96cYY7mW0vJ2NFA7m', '2023-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z'),(2, 'Jane', 'Doe', 'jane.doe@example.com', 'janedoe', '$2b$10$M/WlJFeICXSTwvlM54X75u9Tg5Y3w/ak5T7O96cYY7mW0vJ2NFA7m', '2024-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z');`,
    );
    expect(sqlInserts).toContain(
      `INSERT INTO "post" (post_id, user_id, title, content, created_at, updated_at) VALUES (1, 1, 'John''s Post', 'Lorem ipsum', '2023-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z'),(2, 2, 'Jane''s Post', NULL, '2024-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z');`,
    );
  });
  ...
  it('should generate correct SQL INSERT statements for usersPostsOneToManySchema', () => {
    ...
    expect(sqlInserts).toContain(
      `INSERT INTO "post" (post_id, user_id, title, content, created_at, updated_at) VALUES (1, 1, 'John''s Post', 'Lorem ipsum', '2023-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z'),(2, 1, 'John''s 2nd Post', 'Lorem ipsum', '2023-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z'),(3, 2, 'Jane''s Post', NULL, '2024-06-18T10:17:19.123456Z', '2024-06-18T10:17:19.123456Z');`,
    );
  });
});
